...
if __name__ == '__main__':
    ...
    if rerunSimulations:
        default = Config(size=200, sparseDensity=True, mutationProbability=0.1, initialState=State(1, 1, 8))
        ...
        # E = Experiment(networkType=LrLe_Network, defaultConfig=default, repeats=50,
