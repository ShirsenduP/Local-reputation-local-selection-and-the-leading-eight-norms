...
if __name__ == '__main__':
    ...
    if rerunSimulations:
        ...
        E = Experiment(name='GrGe_All-D_Sparse', networkType=GrGe_Network, defaultConfig=default,
        ...
        E2 = Experiment(name='LrGe_All-D_Sparse', networkType=LrGe_Network, defaultConfig=default2,
                        variable='population', values=pops,
                        repeats=reps)
        E2.run(export=True)

        default3 = Config(size=500, densities=sparseNetworkDensity, mutant=Population(ID=8, Proportion=0.1))
        E3 = Experiment(name='LrLe_All-D_Sparse', networkType=LrLe_Network, defaultConfig=default3,
                        variable='population', values=pops,
                        repeats=reps)
        E3.run(export=True)
        ...
        E4 = Experiment(name='GrGe_All-C_Sparse', networkType=GrGe_Network, defaultConfig=default4,
                        variable='population', values=pops,
                        repeats=reps)
        E4.run(export=True)

        default5 = Config(size=500, densities=sparseNetworkDensity, mutant=Population(ID=9, Proportion=0.1))
        E5 = Experiment(name='LrGe_All-C_Sparse', networkType=LrGe_Network, defaultConfig=default5,
                        variable='population', values=pops,
                        repeats=reps)
        E5.run(export=True)

        default6 = Config(size=500, densities=sparseNetworkDensity, mutant=Population(ID=9, Proportion=0.1))
        E6 = Experiment(name='LrLe_All-C_Sparse', networkType=LrLe_Network, defaultConfig=default6,
                        variable='population', values=pops,
                        repeats=reps)
        E6.run(export=True)
