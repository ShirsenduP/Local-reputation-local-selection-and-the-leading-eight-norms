...
if __name__ == '__main__':
    """Test 5 - MAIN RESULT -> Testing dominance of Leading 8 on sparse network with LrGe setup VS ALL-C"""
    ...
    if rerunSimulations:
        ...
        pops = Experiment.generatePopulationList(proportion=1, mutantID=9)
        E = Experiment(networkType=LrGeERNetwork, defaultConfig=default, repeats=repeats,
