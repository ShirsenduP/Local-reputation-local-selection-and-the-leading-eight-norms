...
if __name__ == '__main__':
    ...
    """Test 6 - Strategy 0 vs All-D. Testing d-Regular Random Lattices with d = [3, 4, ..., 20]."""
    ...
    if rerunSimulations:
        ...
        C = Config(size=200, mutationProbability=0.1, maxPeriods=5000,
